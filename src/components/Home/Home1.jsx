...
<div className="relative min-h-screen flex flex-col sm:flex-row">
      ...
      <div className="flex-1 flex flex-col items-center  ">
        ...
        <div className="w-full max-w-[880px] mt-10 sm:mt-12 flex flex-col items-center px-4 sm:px-0  sm:relative right-30 ">
      ...
      <div className="sm:w-[200px] flex-shrink-0  sm:mt-16 pr-0 pl-0 hidden sm:flex flex-col items-center sm:relative right-45">
        <div className="bg-blue-100 opacity-30 w-full h-[610px] rounded-sm shadow-md sm:relative top-15 right-15">
        ...
        <div className="bg-blue-100 w-full h-[458px] rounded-sm shadow-md mt-6 sm:relative top-15 right-15 "></div>
      </div>
